...
VALUES
  ('patrol', '격리소 순찰', '복도에 굴러다니는 소동을 주워 담습니다.', 'easy', '["defender","scout"]', 20, 40, 70, 5, 0, 180, 1),
  ('mine_guard', '광산 경비', '광산 입구에서 잡석과 유저의 욕심을 감시합니다.', 'normal', '["defender","engineer"]', 35, 70, 60, 10, 0, 300, 1),
  ('incident_suppression', '소동 진압', '격리소의 작은 난리를 큰 난리가 되기 전에 눌러둡니다.', 'normal', '["supporter","medic"]', 30, 65, 62, 8, 0, 420, 1),
  ('closed_zone_scout', '폐쇄구역 정찰', '지도에 없는 문 너머를 확인합니다.', 'hard', '["scout","attacker","engineer"]', 70, 150, 45, 18, 2, 720, 1),
  ('debt_collector', '카지노 채무자 추적', '카지노 근처에서 사라진 포인트의 행방을 묻습니다.', 'dangerous', '["attacker","scout"]', 100, 230, 35, 25, 4, 900, 1)
