...
function renderComments(comments) {
  document.querySelector('#comments-list').innerHTML = comments.map((comment) => `
    <article class="comment-item">
      ...
      ${comment.isAnonymous ? '' : renderTitleBadge({ authorTitle: comment.authorTitle, authorTitleData: comment.authorTitleData, authorTitleRarity: comment.authorTitleRarity }, { compact: true })}
